...
protected:
  ...
  Option *option_;
  AzIntArr _ia_trn_lab, _ia_tst_lab; 
  
public:   
  AzsSvrg(Option *option) : m_trn_x(NULL), m_tst_x(NULL), ia_trn_lab(NULL), ia_tst_lab(NULL), 
              ...
              with_replacement(false), do_compact(false), do_show_loss(false), do_show_timing(false), option_(option) {}
  ...
  void SetWeight(std::vector<real*> &blocks);
